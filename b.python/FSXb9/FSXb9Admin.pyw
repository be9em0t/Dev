...
#install psutil, pywin32, pyuipc-0.3.win32_xxx
...
from tkinter import *
import os, sys, time, tkinter.messagebox
...
if (os.path.exists(scriptDir + '\\FSXb9.ini')) == False:
    tkinter.messagebox.showinfo(title="FSX.b9", message="File FSXb9.ini not found!")
    sys.exit()
...
def configRead(section, option):
    ...
    try:
        ...
        tkinter.messagebox.showinfo(title="FSX.b9", message="Oops! Settings file FSXb9.ini missing!")
        sys.exit()
    try:
        value = config.get(section, option)
    except  :
        tkinter.messagebox.showinfo(title="FSX.b9", message="Oops! Value " + option + " or section " + section + " missing in FSXb9.ini file!\nDefault value created.")
...
if fsxProc == None:
    tkinter.messagebox.showinfo(title="FSX.b9", message="FSX not running.")
