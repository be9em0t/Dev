...
Gui add, activeX, w100 h90 vTest, about:<!DOCTYPE HTML><meta http-equiv="X-UA-Compatible" content="IE=Edge">
test.silent := true
test.navigate("d:\Work\OneDrive\Dev\Ahk\Experimental\GUI.html.vector\Untitled.html")
